...
/**
 *	Raises or lowers the intake elevator at a constant speed.
 *	Useful for autonomous period.
 */
public class ConstantElevateIntake extends Command {
	 ...
	 */
	public ConstantElevateIntake(int raiseElevator) {
	 ...
	 * moving down)
	 */
	public ConstantElevateIntake(double elevatorSpeed) {
